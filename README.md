...
- Verenthorn é um projeto de jogo web focado em estratégia, construído do zero utilizando as tecnologias fundamentais do front-end: HTML5, CSS3 e JavaScript.

- Embora sua mecânica de combate principal seja inspirada no sistema clássico de Jo-Ken-Po (uma trindade de vantagens e desvantagens), o jogo eleva esse conceito transformando os "tipos" em cartas dinâmicas que batalham em rodadas.

# 💻 O Desafio Técnico: Orientação a Objetos (POO)

- O principal objetivo de desenvolvimento do Verenthorn é ser um laboratório prático para a implementação de preceitos de Programação Orientada a Objetos.

- Em vez de utilizar scripts soltos, o motor do jogo foi planejado para ser modular e escalável. Isso inclui:

- Classes e Encapsulamento: Toda a lógica de sorteio, regras de vitória e controle de rodadas fica contida dentro de uma classe gerenciadora (ex: JokenpoGame).
...
🎨 Pinceladas: Visíveis, texturizadas, com granulação

🎨 Cores: Paleta terrosa + tons de sangue, roxo queimado, preto e branco fantasma

🎨 Iluminação: Dramática, contrastes fortes (claro-escuro)

🎨 Bordas: Escurecidas, com vinheta e desgaste

🎨 Fundos: Ambientes ruinosos, florestas mortas, castelos em ruínas, neblina eterna
